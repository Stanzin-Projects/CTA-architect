    ...
    <footer className="bg-stone-900 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <div className="mb-4">
              <span className="text-lg tracking-[0.3em] font-medium uppercase" style={{ fontFamily: 'Georgia, serif' }}>CTA</span>
              <span className="text-[10px] tracking-[0.25em] uppercase text-stone-400 block" style={{ fontFamily: 'Georgia, serif' }}>Studio</span>
            </div>
